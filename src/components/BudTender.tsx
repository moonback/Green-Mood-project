                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed bottom-6 right-6 z-50 w-[min(420px,calc(100vw-24px))] h-[min(600px,85vh)] bg-zinc-900 border border-zinc-800 rounded-3xl shadow-2xl flex flex-col overflow-hidden"
                            ...
                            <div className="flex items-center gap-3 px-5 py-4 border-b border-zinc-800 bg-zinc-950/60">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-green-neon/80 flex items-center gap-1">
                                        <span className="w-1.5 h-1.5 bg-green-neon rounded-full" />
