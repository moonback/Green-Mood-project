 ...
 */
export default function BudTenderWidget({ onClick, pulse = false, unreadCount = 0, mode = 'default' }: BudTenderWidgetProps) {
    ...
    return (
        <motion.button
            ...
            className={`fixed bottom-6 right-6 z-[99999] flex items-center gap-3 border text-white rounded-2xl px-5 py-4 transition-all group ${pulse ? 'animate-pulse-slow' : ''} ${isExpand
